...
function ExpressHandlebars(config) {
    ...
    utils.assign(this, {
        ...
        extname        : '.handlebars',
        layoutsDir     : './src/modules/mail/', // Default layouts directory is relative to `express settings.view` + `layouts/`
        partialsDir    : './src/modules/mail/', // Default partials directory is relative to `express settings.view` + `partials/`
